...
numerical data (we mostly ignored the built-in contains provided
directly in Python).
...
\item
  ...
  (imagine we have some missing values)
\item
...
\item
  ...
  but the pandas library offers much more beyond that, so there is
...
\def\labelenumi{\arabic{enumi}.}
\item
  Data is clearly organised in variables and observations, similar to
  econometrics programs such as Stata.
\item
...
The easiest way to get a \texttt{Series} or \texttt{DataFrame} is to
...
dictionary as an argument, where each key contains a column name and
each corresponding value the data for that variable.
...
To illustrate, we use a data set of a few UK universities that contains
their name, number of students and budget in million pounds (both from
Wikipedia), and their
\href{https://www.timeshighereducation.com/world-university-rankings}{Times
Higher Education (THE) ranking}.

We can read in the data stored in \texttt{universities.csv} and display
the first three rows like this:
...
memory usage: 1.2+ KB
    ...
    Note that pandas automatically discards missing information in
computations. For example, the budget for Swansea University is missing,
and this observation is therefore dropped when computing descriptive
statistics.
...
\tightlist
\item
  Indexing by position. This is basically identical indexing of other
  Python and NumPy containers.
\item
...
\texttt{.iloc{[}{]}} for position indexing.
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df}\PY{p}{[}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rank}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]}     \PY{c+c1}{\PYZsh{} select multiple columns using a list}
\end{Verbatim}
\end{tcolorbox}
...
For example, we can replace the row index and use the labels \texttt{a},
\texttt{b}, \texttt{c}, \ldots{} instead of integers as follows:
...
\PY{c+c1}{\PYZsh{} Map list of integers to lower\PYZhy{}case roman letters}
\PY{n}{index} \PY{o}{=} \PY{p}{[}\PY{n+nb}{chr}\PY{p}{(}\PY{l+m+mi}{97}\PY{o}{+}\PY{n}{i}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n}{df}\PY{o}{.}\PY{n}{index}\PY{o}{.}\PY{n}{values}\PY{p}{]}
\PY{n}{index}
\end{Verbatim}
\end{tcolorbox}
...
labels, the last element \emph{is} included!
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{a}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{c}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Students}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{a}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{c}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Students}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rank}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    This includes all the columns between \texttt{Students} and
\texttt{Rank}, where the latter is again included since we are slicing
by label.

Trying to pass in positional arguments will return an error if the index
does not happen to be of type integer and the given values are actual
labels:
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexing.py} in \textcolor{ansi-cyan}{\_\_getitem\_\_}\textcolor{ansi-blue}{(self, key)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexing.py} in \textcolor{ansi-cyan}{\_getitem\_axis}\textcolor{ansi-blue}{(self, key, axis)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexing.py} in \textcolor{ansi-cyan}{\_get\_slice\_axis}\textcolor{ansi-blue}{(self, slice\_obj, axis)}
...
\textcolor{ansi-green-intense}{\textbf{   1122}}         indexer = labels.slice\_indexer(
\textcolor{ansi-green}{-> 1123}\textcolor{ansi-red}{             }slice\_obj\textcolor{ansi-blue}{.}start\textcolor{ansi-blue}{,} slice\_obj\textcolor{ansi-blue}{.}stop\textcolor{ansi-blue}{,} slice\_obj\textcolor{ansi-blue}{.}step\textcolor{ansi-blue}{,} kind\textcolor{ansi-blue}{=}\textcolor{ansi-blue}{"loc"}
\textcolor{ansi-green-intense}{\textbf{   1124}}         )
\textcolor{ansi-green-intense}{\textbf{   1125}} 

\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexes/base.py} in \textcolor{ansi-cyan}{slice\_indexer}\textcolor{ansi-blue}{(self, start, end, step, kind)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexes/base.py} in \textcolor{ansi-cyan}{slice\_locs}\textcolor{ansi-blue}{(self, start, end, step, kind)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexes/base.py} in \textcolor{ansi-cyan}{get\_slice\_bound}\textcolor{ansi-blue}{(self, label, side, kind)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexes/base.py} in \textcolor{ansi-cyan}{\_maybe\_cast\_slice\_bound}\textcolor{ansi-blue}{(self, label, side, kind)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/pandas/core/indexes/base.py} in \textcolor{ansi-cyan}{\_invalid\_indexer}\textcolor{ansi-blue}{(self, form, key)}
\textcolor{ansi-green-intense}{\textbf{   3266}}         """
\textcolor{ansi-green-intense}{\textbf{   3267}}         raise TypeError(
\textcolor{ansi-green}{-> 3268}\textcolor{ansi-red}{             }\textcolor{ansi-blue}{f"cannot do \{form\} indexing on \{type(self).\_\_name\_\_\} with these "}
\textcolor{ansi-green-intense}{\textbf{   3269}}             \textcolor{ansi-blue}{f"indexers [\{key\}] of type \{type(key).\_\_name\_\_\}"}
\textcolor{ansi-green-intense}{\textbf{   3270}}         )
...
\subsubsection{Selection by position}\label{selection-by-position}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Set Aberdeen\PYZsq{}s THE ranking to missing}
\PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{n}{df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{University of Aberdeen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rank}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{nan}
\PY{n}{df}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{n}{df}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{University of Aberdeen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} mean() automatically drops missing observations}
\PY{n}{df}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    Here \texttt{groups} is a special pandas objects which can be
subsequently be used to process group-specific data. To compute the
group-wise averages, we can simply run
...
\end{tcolorbox}
    ...
    There are numerous routines available to aggregate grouped data, for
example:
...
The most flexible aggregate function is \texttt{apply()}, which calls
the given function with the entire group-specific subset of data
(including all columns) and glues together the results.
...
which allow us to quickly inspect data stored in \texttt{DataFrames}. We
can of course alternatively extract the numerical data and pass it to
Matplotlib's routines instead.
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit8_files/unit8_58_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit8_files/unit8_60_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit8_files/unit8_62_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit8_files/unit8_64_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit8_files/unit8_67_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
