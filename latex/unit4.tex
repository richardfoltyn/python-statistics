...
the function, except for optional unnamed arguments. We can just use the
\texttt{name=value} syntax:
...
value. This means assigning a different value to an argument within a
function has no effect outside of the function:
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
func1 called with argument <function func2 at 0x7f1c8ef408c0>
    \end{Verbatim}
...
The module \texttt{unit4\_mod.py} contains the following definitions:
...
\item
  ...
  objects from \texttt{unit4\_mod}.
\item
  We can select which names from \texttt{unit4\_mod} should be directly
  accessible.
\end{enumerate}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{import} \PY{n+nn}{unit4\PYZus{}mod}

\PY{c+c1}{\PYZsh{} Access variable defined in unit4\PYZus{}mod}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unit4\PYZus{}mod}\PY{o}{.}\PY{n}{var}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Call function defined in unit4\PYZus{}mod}
\PY{n}{unit4\PYZus{}mod}\PY{o}{.}\PY{n}{func}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
1
func in module unit4\_mod called
    \end{Verbatim}

    If a symbol from \texttt{unit4\_mod} is used frequently, we might want
to make it accessible without the \texttt{unit4\_mod} prefix. This is
the second variant:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{24}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{unit4\PYZus{}mod} \PY{k+kn}{import} \PY{n}{var}\PY{p}{,} \PY{n}{func}
...
\texttt{unit4\_mod}, as in the following example?

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{25}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{unit4\PYZus{}mod} \PY{k+kn}{import} \PY{n}{func}

\PY{k}{def} \PY{n+nf}{func}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{func in notebook called}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{n}{func}\PY{p}{(}\PY{p}{)}          \PY{c+c1}{\PYZsh{} Calls func() defined in notebook}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{unit4\PYZus{}mod} \PY{k+kn}{import} \PY{n}{func} \PY{k}{as} \PY{n}{imported\PYZus{}func}     \PY{c+c1}{\PYZsh{} The function formerly known}
...
\PY{c+c1}{\PYZsh{} call func from module unit4\PYZus{}mod}
