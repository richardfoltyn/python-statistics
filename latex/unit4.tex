...
\textcolor{ansi-green}{<ipython-input-1-f059e7c62df7>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      3}} 
\textcolor{ansi-green-intense}{\textbf{      4}} items \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{(}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{2}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{3}\textcolor{ansi-blue}{)}          \textcolor{ansi-red}{\# create tuple of integers}
\textcolor{ansi-green}{----> 5}\textcolor{ansi-red}{ }func\textcolor{ansi-blue}{(}items\textcolor{ansi-blue}{)}

\textcolor{ansi-green}{<ipython-input-1-f059e7c62df7>} in \textcolor{ansi-cyan}{func}\textcolor{ansi-blue}{(x)}
\textcolor{ansi-green-intense}{\textbf{      1}} \textcolor{ansi-green}{def} func\textcolor{ansi-blue}{(}x\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{:}
\textcolor{ansi-green}{----> 2}\textcolor{ansi-red}{     }x\textcolor{ansi-blue}{[}\textcolor{ansi-cyan}{0}\textcolor{ansi-blue}{]} \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{'modified in func'}
\textcolor{ansi-green-intense}{\textbf{      3}} 
\textcolor{ansi-green-intense}{\textbf{      4}} items \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{(}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{2}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{3}\textcolor{ansi-blue}{)}          \textcolor{ansi-red}{\# create tuple of integers}
\textcolor{ansi-green-intense}{\textbf{      5}} func\textcolor{ansi-blue}{(}items\textcolor{ansi-blue}{)}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
func1 called with argument <function func2 at 0x7f0738d2ae50>
    \end{Verbatim}
...
\PY{c+c1}{\PYZsh{} Calls func() defined in unit4\PYZus{}mod}
\PY{n}{func}\PY{p}{(}\PY{p}{)}         

\PY{c+c1}{\PYZsh{} overwrites definition from unit4\PYZus{}mod with local version}
\PY{k}{def} \PY{n+nf}{func}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{import} \PY{n+nn}{unit4\PYZus{}mod} \PY{k}{as} \PY{n+nn}{u4m}

\PY{n}{u4m}\PY{o}{.}\PY{n}{func}\PY{p}{(}\PY{p}{)}    \PY{c+c1}{\PYZsh{} call function from module unit4\PYZus{}mod}
\end{Verbatim}
\end{tcolorbox}
