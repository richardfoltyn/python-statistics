...
\PY{n}{dtypes} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dtype}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{U30}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,}      \PY{c+c1}{\PYZsh{} unicode string of length 30}
                   ...
                   \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ranking}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{i4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{]}\PY{p}{)}
...
\textcolor{ansi-red}{---------------------------------------------------------------------------}
\textcolor{ansi-red}{ValueError}                                Traceback (most recent call last)
\textcolor{ansi-green}{<ipython-input-1-e1c8dcd4434d>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{     10}}                    ('Ranking', 'i4')])
\textcolor{ansi-green-intense}{\textbf{     11}} 
\textcolor{ansi-green}{---> 12}\textcolor{ansi-red}{ }data \textcolor{ansi-blue}{=} np\textcolor{ansi-blue}{.}loadtxt\textcolor{ansi-blue}{(}file\textcolor{ansi-blue}{,} delimiter\textcolor{ansi-blue}{=}\textcolor{ansi-blue}{';'}\textcolor{ansi-blue}{,} skiprows\textcolor{ansi-blue}{=}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{,} dtype\textcolor{ansi-blue}{=}dtypes\textcolor{ansi-blue}{)}
...
flexible and can also deal with missing data. Missing values are
assigned the value \texttt{np.nan}:
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Saving CSV file to /tmp/tmpujo7sdo\_/data.csv
    \end{Verbatim}
...
\item
  \texttt{read\_fwf()}: Read data with fixed field widths, ie. text data
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Pickled data written to /tmp/tmp7t67n1ub/data.bin
    \end{Verbatim}
...
\item
  ...
  \item
    ...
    are \emph{not} human-readable text.
  \end{itemize}
\item
