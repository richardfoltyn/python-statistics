...
In this unit we discuss input and output, or I/O for short. In doing so,
we focus exclusively on I/O routines used to load and store data from
files that are relevant for numerical computation and data analysis.
...
used NumPy I/O routine, \texttt{np.loadtxt()}. The most important I/O
functions to process text data are:

\begin{itemize}
\tightlist
\item
  \texttt{loadtxt()}: load data from a text file.
\item
  \texttt{genfromtxt()}: load data from a text file and handle missing
  data and heterogenous data.
\item
  \texttt{savetxt()}: save a NumPy array to a text file.
\end{itemize}

There are a few other I/O functions in NumPy, for example to write
arrays as raw binary data. These are listed in the
\href{https://numpy.org/doc/stable/reference/routines.io.html}{official
documentation}.

We frequently use files that store data as character-separated values
(CSV) in pure text format since virtually and application supports this
data format. Imagine we have the following tabular data from
...
To load a CSV file as a NumPy array, we use \texttt{loadtxt()}:
...
\PY{n}{data} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{loadtxt}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../data/FRED.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{skiprows}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{delimiter}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{,}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
CSV file you might have. However, you'll occasionally want to specify
the following arguments to override the defaults:
...
\texttt{np.genfromtxt()}. This routine is more flexible: among other
things, it can handle missing values, or data that mixes strings and
numerical values.

For example, when we try to load our sample of universities with
\texttt{loadtxt()}, we get the following error:
...
\PY{n}{filename} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../data/universities.csv}\PY{l+s+s1}{\PYZsq{}}
...
\textcolor{ansi-green}{<ipython-input-1-26b757ebcd56>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      4}} \textcolor{ansi-red}{\# Try to load CSV data that contains strings}
\textcolor{ansi-green-intense}{\textbf{      5}} \textcolor{ansi-red}{\# This will result in an error!}
\textcolor{ansi-green}{----> 6}\textcolor{ansi-red}{ }data \textcolor{ansi-blue}{=} np\textcolor{ansi-blue}{.}loadtxt\textcolor{ansi-blue}{(}filename\textcolor{ansi-blue}{,} delimiter\textcolor{ansi-blue}{=}\textcolor{ansi-blue}{';'}\textcolor{ansi-blue}{,} skiprows\textcolor{ansi-blue}{=}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{)}

\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/numpy/lib/npyio.py} in \textcolor{ansi-cyan}{loadtxt}\textcolor{ansi-blue}{(fname, dtype, comments, delimiter, converters, skiprows, usecols, unpack, ndmin, encoding, max\_rows)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/numpy/lib/npyio.py} in \textcolor{ansi-cyan}{read\_data}\textcolor{ansi-blue}{(chunk\_size)}
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/numpy/lib/npyio.py} in \textcolor{ansi-cyan}{<listcomp>}\textcolor{ansi-blue}{(.0)}
\textcolor{ansi-green-intense}{\textbf{   1065}} 
\textcolor{ansi-green-intense}{\textbf{   1066}}             \textcolor{ansi-red}{\# Convert each value according to its column and store}
\textcolor{ansi-green}{-> 1067}\textcolor{ansi-red}{             }items \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{[}conv\textcolor{ansi-blue}{(}val\textcolor{ansi-blue}{)} \textcolor{ansi-green}{for} \textcolor{ansi-blue}{(}conv\textcolor{ansi-blue}{,} val\textcolor{ansi-blue}{)} \textcolor{ansi-green}{in} zip\textcolor{ansi-blue}{(}converters\textcolor{ansi-blue}{,} vals\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{]}
\textcolor{ansi-green-intense}{\textbf{   1068}} 
...
\textcolor{ansi-green}{\textasciitilde{}/.conda/envs/py3-default/lib/python3.7/site-packages/numpy/lib/npyio.py} in \textcolor{ansi-cyan}{floatconv}\textcolor{ansi-blue}{(x)}
...
accomplished by constructing a special \texttt{dtype} that specifies the
...
\PY{n}{dtypes} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{dtype}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{U30}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Country}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{U20}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,}
                   \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Founded}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{i4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Students}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{i4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,}
                   \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Budget}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{f8}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ranking}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{i4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\PY{n}{data} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{loadtxt}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{delimiter}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{;}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{skiprows}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{dtypes}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\textcolor{ansi-red}{---------------------------------------------------------------------------}
\textcolor{ansi-red}{ValueError}                                Traceback (most recent call last)
\textcolor{ansi-green}{<ipython-input-1-a3f6538f35c6>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      3}}                    \textcolor{ansi-blue}{(}\textcolor{ansi-blue}{'Founded'}\textcolor{ansi-blue}{,} \textcolor{ansi-blue}{'i4'}\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{,} \textcolor{ansi-blue}{(}\textcolor{ansi-blue}{'Students'}\textcolor{ansi-blue}{,} \textcolor{ansi-blue}{'i4'}\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{,}
\textcolor{ansi-green-intense}{\textbf{      4}}                    ('Budget', 'f8'), ('Ranking', 'i4')])
\textcolor{ansi-green}{----> 5}\textcolor{ansi-red}{ }data \textcolor{ansi-blue}{=} np\textcolor{ansi-blue}{.}loadtxt\textcolor{ansi-blue}{(}filename\textcolor{ansi-blue}{,} delimiter\textcolor{ansi-blue}{=}\textcolor{ansi-blue}{';'}\textcolor{ansi-blue}{,} skiprows\textcolor{ansi-blue}{=}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{,} dtype\textcolor{ansi-blue}{=}dtypes\textcolor{ansi-blue}{)}
...
\textcolor{ansi-red}{ValueError}: could not convert string to float: 
    ...
    However, this still fails because the budget for Swansea University is
missing.

We can get around this by using \texttt{genfromtxt()} which assigns the
\texttt{np.nan} to missing values:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{4}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{data} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{genfromtxt}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{delimiter}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{;}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{n}{dtypes}\PY{p}{,} \PY{n}{encoding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{utf8}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{data}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}        \PY{c+c1}{\PYZsh{} print last observation}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
('"Swansea University"', '"Wales"', 1920, 20620, nan, 251)
\end{Verbatim}
\end{tcolorbox}
...
\PY{c+c1}{\PYZsh{} CSV file name}
\PY{n}{filename} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{d}\PY{o}{.}\PY{n}{name}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Print destination file \PYZhy{} this will be different each time}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Saving CSV file to }\PY{l+s+si}{\PYZob{}}\PY{n}{filename}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{c+c1}{\PYZsh{} Write NumPy array to CSV file}
\PY{n}{np}\PY{o}{.}\PY{n}{savetxt}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{data}\PY{p}{,} \PY{n}{delimiter}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{;}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fmt}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{}8.5f}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
The destination file is located in a temporary directory which will be
different every time this code is run. We use the \texttt{tempfile}
module to create this writeable temporary directory.
...
\item
  It supports heterogeneous data without having to specify the data type
  in advance.
\item
...
\item
  \texttt{read\_fwf()}: Read data with fixed field width, ie. text data
  that does not use delimiters to separate fields.
\item
  \texttt{read\_excel()}, \texttt{to\_excel()}: Read or write Excel
  spreadsheets
\item
  \texttt{read\_stata()}, \texttt{to\_stata()}: Rear or write Stata's
  \texttt{.dta} files.
\end{itemize}
...
\texttt{read\_csv()}. Since this file contains only floating-point data,
the result is very similar to reading in a NumPy array.
...
\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{sep}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{,}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
                   Institution           Country  Founded  Students  Budget  \textbackslash{}
...
\PY{n}{filename} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../data/../data/universities.xlsx}\PY{l+s+s1}{\PYZsq{}}

\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}excel}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{sheet\PYZus{}name}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{universities}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
fixed-width files are easy to create in Fortran). To read such files,
the width (ie. the number of characters) has to be explicitly specified:
...
\PY{n}{filename} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{../data/FRED\PYZhy{}fixed.csv}\PY{l+s+s1}{\PYZsq{}}

\PY{c+c1}{\PYZsh{} field widths are passed as list to read\PYZus{}fwf()}
\PY{n}{df} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}fwf}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{n}{widths}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{]}\PY{p}{)}
\PY{n}{df}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{filename} \PY{o}{=} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{join}\PY{p}{(}\PY{n}{d}\PY{o}{.}\PY{n}{name}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{data.bin}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{c+c1}{\PYZsh{} print destination file path}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Pickled data written to }\PY{l+s+si}{\PYZob{}}\PY{n}{filename}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{n}{arr}         \PY{c+c1}{\PYZsh{} prints previously generated array}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    The above example introduces a few concepts we have not countered so
far:
...
\item
  ...
  \item
    The \texttt{b} sets the file mode to \emph{binary}, ie. its contents
    are not human-readable text.
  \end{itemize}
\item
...
\item
  Some object cannot be pickled automatically. For example, this applies
  to any classes defined with Numba or Cython, unless special care is
  taken to implement the pickle protocol.
\end{enumerate}
