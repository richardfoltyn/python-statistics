...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Saving CSV file to /tmp/tmpdpfcki9d/data.csv
    \end{Verbatim}
...
\item
  ...
  Read data with fixed field widths, i.e.~text data that does not use
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Pickled data written to /tmp/tmpk5h20em9/data.bin
    \end{Verbatim}
