...
need to obtain an RNG instance. We can get the default RNG as follows:
...
\begin{Verbatim}[commandchars=\\\{\}]
array([0.14110599, 0.67004558, 0.42633773, 0.79077279, 0.39398058])
\end{Verbatim}
\end{tcolorbox}
...
To draw floats on the unit interval, we use \texttt{random\_sample()}:
...
\end{tcolorbox}
    ...
    Random integers can be generated using \texttt{randint()}:
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_24_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_26_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.legend.Legend at 0x7f9c65262160>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_28_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{figure}
\centering
\includegraphics{solutions/unit7/unit7_ex2_PDF.pdf}
...
\item
  ...
  \begin{figure}
  \centering
  \includegraphics{solutions/unit7/unit7_ex2_MC.pdf}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_49_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.legend.Legend at 0x7f9c6487d4c0>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_63_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_66_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_68_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_72_1.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{unit7_files/unit7_74_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
