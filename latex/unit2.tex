...
\textcolor{ansi-green}{<ipython-input-1-b2ae5c713a73>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      1}} \textcolor{ansi-red}{\# cannot create f-string using unknown names}
\textcolor{ansi-green}{----> 2}\textcolor{ansi-red}{ }s \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{f'\{unknown\} is not defined'}

\textcolor{ansi-red}{NameError}: name 'unknown' is not defined
    \end{Verbatim}
...
\textcolor{ansi-red}{---------------------------------------------------------------------------}
\textcolor{ansi-red}{TypeError}                                 Traceback (most recent call last)
\textcolor{ansi-green}{<ipython-input-1-694af2e67847>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green}{----> 1}\textcolor{ansi-red}{ }list1 \textcolor{ansi-blue}{+=} \textcolor{ansi-cyan}{10}
...
\end{tcolorbox}
    ...
    It might be surpising that this works since a \texttt{tuple} is an
...
\textcolor{ansi-red}{---------------------------------------------------------------------------}
\textcolor{ansi-red}{TypeError}                                 Traceback (most recent call last)
\textcolor{ansi-green}{<ipython-input-1-52d158bdddcb>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      3}} 
\textcolor{ansi-green-intense}{\textbf{      4}} \textcolor{ansi-red}{\# Cannot concatenate list and tuple!}
\textcolor{ansi-green}{----> 5}\textcolor{ansi-red}{ }lst \textcolor{ansi-blue}{+} tpl

\textcolor{ansi-red}{TypeError}: can only concatenate list (not "tuple") to list
    \end{Verbatim}
