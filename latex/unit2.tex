...
\begin{document}
    ...
    \hypertarget{unit-2-language-and-numpy-basics}{%
\section{Unit 2: Language and NumPy
basics}\label{unit-2-language-and-numpy-basics}}
...
Hello, world!
    ...
    In IPython notebooks and interactive command-line environments, we can
...
\end{tcolorbox}
    ...
    This does not do anything in \emph{proper} python script files that are
run through the interpreter, though.
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{first} \PY{o}{=} \PY{n}{items}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{c+c1}{\PYZsh{} contains \PYZsq{}foo\PYZsq{}}
\PY{n}{first}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{second} \PY{o}{=} \PY{n}{items}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{c+c1}{\PYZsh{} contains second element}
\PY{n}{second}
\end{Verbatim}
\end{tcolorbox}
...
\textcolor{ansi-green}{<ipython-input-1-b4be5dad43c1>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      1}} \textcolor{ansi-red}{\# This raises an error!}
\textcolor{ansi-green-intense}{\textbf{      2}} items \textcolor{ansi-blue}{=} \textcolor{ansi-blue}{'foo'}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{,} \textcolor{ansi-cyan}{1.0}
\textcolor{ansi-green}{----> 3}\textcolor{ansi-red}{ }items\textcolor{ansi-blue}{[}\textcolor{ansi-cyan}{0}\textcolor{ansi-blue}{]} \textcolor{ansi-blue}{=} \textcolor{ansi-cyan}{123}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{lst}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bar}\PY{l+s+s1}{\PYZsq{}}
\PY{n}{lst}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{n} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{lst}\PY{p}{)}
...
\item
  Dictionaries are unordered, ie. elements stored in dictionaries cannot
  be retrieved in any guaranteed order.
\end{itemize}
...
\PY{n}{dct} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{University of Glasgow}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
       \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{course}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Python bootcamp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}
\PY{n}{dct}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\{'institution': 'University of Glasgow', 'course': 'Python bootcamp'\}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{value} \PY{o}{=} \PY{n}{dct}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{institution}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\PY{n}{value}
\end{Verbatim}
\end{tcolorbox}
...
arguments. The end value is NOT included.
...
\end{tcolorbox}
    ...
    \hypertarget{creating-arrays-from-other-python-objects}{%
\paragraph{Creating arrays from other Python
objects}\label{creating-arrays-from-other-python-objects}}
...
\end{tcolorbox}
    ...
    We use \texttt{-1} to let NumPy automatically compute the size of one
remaining dimension.
...
\end{tcolorbox}
    ...
    \textbf{Important}: the reshaped array must have the same number of
elements!
...
\textcolor{ansi-green}{<ipython-input-1-d98d07ea8aa9>} in \textcolor{ansi-cyan}{<module>}
\textcolor{ansi-green-intense}{\textbf{      1}} \textcolor{ansi-green}{import} numpy \textcolor{ansi-green}{as} np
\textcolor{ansi-green-intense}{\textbf{      2}} mat \textcolor{ansi-blue}{=} np\textcolor{ansi-blue}{.}arange\textcolor{ansi-blue}{(}\textcolor{ansi-cyan}{6}\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{.}reshape\textcolor{ansi-blue}{(}\textcolor{ansi-blue}{(}\textcolor{ansi-cyan}{2}\textcolor{ansi-blue}{,}\textcolor{ansi-blue}{-}\textcolor{ansi-cyan}{1}\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{)}
\textcolor{ansi-green}{----> 3}\textcolor{ansi-red}{ }mat\textcolor{ansi-blue}{.}reshape\textcolor{ansi-blue}{(}\textcolor{ansi-blue}{(}\textcolor{ansi-cyan}{2}\textcolor{ansi-blue}{,}\textcolor{ansi-cyan}{2}\textcolor{ansi-blue}{)}\textcolor{ansi-blue}{)}      \textcolor{ansi-red}{\# Cannot reshape 6 into 4 elements!}

\textcolor{ansi-red}{ValueError}: cannot reshape array of size 6 into shape (2,2)
    \end{Verbatim}

    \hypertarget{indexing}{%
\subsubsection{Indexing}\label{indexing}}

\hypertarget{single-element-indexing}{%
\paragraph{Single element indexing}\label{single-element-indexing}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{mat}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}    \PY{c+c1}{\PYZsh{} returns element in row 2, column 2}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    It is important to pass multi-dimensional indices as a tuple to within
brackets, ie \texttt{{[}1,1{]}} in the above example. We could
alternatively write \texttt{mat{[}1{]}{[}1{]}}, which would give the
same result:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{37}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{mat}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{==} \PY{n}{mat}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}       \PY{c+c1}{\PYZsh{} don\PYZsq{}t do this!}
\end{Verbatim}
\end{tcolorbox}
...
sub-dimensional array \texttt{mat{[}1{]}}, and then applies the second
index to this array.

    \hypertarget{index-slices}{%
\paragraph{Index slices}\label{index-slices}}
...
\item
  The end value is NOT included. Writing \texttt{vec{[}0:n{]}} does not
  include element with index \(n\)!
\item
...
\end{tcolorbox}
    ...
    \hypertarget{indexing-lists-and-tuples}{%
\paragraph{Indexing lists and tuples}\label{indexing-lists-and-tuples}}
...
You can explicitly specify the numerical data type when creating NumPy
arrays.
...
\end{tcolorbox}
    ...
    Often we don't care about the data type too much, but keep in mind
that\\

\begin{itemize}
\tightlist
\item
  Floating-point has limited precision, even for integers larger than
  (approximately) \(10^{16}\)
\item
...
\PY{c+c1}{\PYZsh{} Add floating\PYZhy{}point value 0.234 to second element in place}
\PY{n}{arr}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mf}{0.234}
\PY{n}{arr}
\end{Verbatim}
\end{tcolorbox}
...
values of specify a floating-point \texttt{dtype} argument when we want
data to be interpreted as floating-point values, eg. always write 1.0
...
For floats we have additional options: - \texttt{\{:w.df\}} specifies
that a float should be formatted using a field width \texttt{w} and
\texttt{d} decimal digits.
...
\PY{n}{fmt} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{The current version of Python is }\PY{l+s+si}{\PYZob{}:.0f\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}
...
\begin{Verbatim}[commandchars=\\\{\}]
'The current version of Python is 4'
\end{Verbatim}
\end{tcolorbox}
